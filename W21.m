...
lme_PPD_II = fitlme(Tab_II,'PPD~Activity*Noise+(1|Subject)');

lme_MPD_S_II = fitlme(Tab_S_II,'MPD~Activity*Setting+(1|Subject)');
lme_Slo_S_II = fitlme(Tab_S_II,'Slope~Activity*Setting+(1|Subject)');
lme_PPD_S_II = fitlme(Tab_S_II,'PPD~Activity*Setting+(1|Subject)');
...
boxplotGroup(ax1,{Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'Quiet')),:).MPD,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'SHL')),:).MPD,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'N60')),:).MPD,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'N70')),:).MPD},...
...
boxplotGroup(ax2,{Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'Quiet')),:).MPD,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'SHL')),:).MPD,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'N60')),:).MPD,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'N70')),:).MPD},...
'PrimaryLabels', {'Quiet','SHL','N60','N70'}, ...
...
boxplotGroup(ax3,{Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'Quiet')),:).Slope,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'SHL')),:).Slope,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'N60')),:).Slope,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'N70')),:).Slope},...
'PrimaryLabels', {'Quiet','SHL','N60','N70'}, ...
'SecondaryLabels', {'Speaking'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
'Colors',[QuietColor;SHLColor;N60Color;N70Color],'GroupType','betweenGroups');
boxplotGroup(ax4,{Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'Quiet')),:).Slope,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'SHL')),:).Slope,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'N60')),:).Slope,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'N70')),:).Slope},...
'PrimaryLabels', {'Quiet','SHL','N60','N70'}, ...
'SecondaryLabels', {'Listening'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
...
boxplotGroup(ax5,{Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'Quiet')),:).PPD,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'SHL')),:).PPD,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'N60')),:).PPD,Tab_I(and(contains(Tab_I.Activity,'Speak'),contains(Tab_I.Noise,'N70')),:).PPD},...
'PrimaryLabels', {'Quiet','SHL','N60','N70'}, ...
'SecondaryLabels', {'Speaking'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
'Colors',[QuietColor;SHLColor;N60Color;N70Color],'GroupType','betweenGroups');
boxplotGroup(ax6,{Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'Quiet')),:).PPD,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'SHL')),:).PPD,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'N60')),:).PPD,Tab_I(and(contains(Tab_I.Activity,'Listen'),contains(Tab_I.Noise,'N70')),:).PPD},...
'PrimaryLabels', {'Quiet','SHL','N60','N70'}, ...
'SecondaryLabels', {'Listening'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
...
boxplotGroup(ax7,{Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'Quiet')),:).MPD,Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'N60')),:).MPD,Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'N70')),:).MPD},...
'PrimaryLabels', {'Quiet','N60','N70'}, ...
'SecondaryLabels', {'Speaking'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
'Colors',[QuietColor;N60Color;N70Color],'GroupType','betweenGroups');
boxplotGroup(ax8,{Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'Quiet')),:).MPD,Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'N60')),:).MPD,Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'N70')),:).MPD},...
'PrimaryLabels', {'Quiet','N60','N70'}, ...
'SecondaryLabels', {'Listening'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
...
boxplotGroup(ax9,{Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'Quiet')),:).Slope,Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'N60')),:).Slope,Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'N70')),:).Slope},...
'PrimaryLabels', {'Quiet','N60','N70'}, ...
'SecondaryLabels', {'Speaking'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
'Colors',[QuietColor;N60Color;N70Color],'GroupType','betweenGroups');
boxplotGroup(ax10,{Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'Quiet')),:).Slope,Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'N60')),:).Slope,Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'N70')),:).Slope},...
'PrimaryLabels', {'Quiet','N60','N70'}, ...
'SecondaryLabels', {'Listening'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
...
boxplotGroup(ax11,{Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'Quiet')),:).PPD,Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'N60')),:).PPD,Tab_II(and(contains(Tab_II.Activity,'Speak'),contains(Tab_II.Noise,'N70')),:).PPD},...
'PrimaryLabels', {'Quiet','N60','N70'}, ...
'SecondaryLabels', {'Speaking'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
'Colors',[QuietColor;N60Color;N70Color],'GroupType','betweenGroups');
boxplotGroup(ax12,{Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'Quiet')),:).PPD,Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'N60')),:).PPD,Tab_II(and(contains(Tab_II.Activity,'Listen'),contains(Tab_II.Noise,'N70')),:).PPD},...
'PrimaryLabels', {'Quiet','N60','N70'}, ...
'SecondaryLabels', {'Listening'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
...
% Settings A_II
boxplotGroup(ax13,{Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'UN')),:).MPD,Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'AA')),:).MPD,Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'AB')),:).MPD},...
'PrimaryLabels', {'UN','AA','AB'}, ...
'SecondaryLabels', {'Speaking'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
'Colors',[UNColor;AAColor;ABColor],'GroupType','betweenGroups');
boxplotGroup(ax14,{Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'UN')),:).MPD,Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'AA')),:).MPD,Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'AB')),:).MPD},...
'PrimaryLabels', {'UN','AA','AB'}, ...
'SecondaryLabels', {'Listening'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
...
boxplotGroup(ax15,{Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'UN')),:).Slope,Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'AA')),:).Slope,Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'AB')),:).Slope},...
'PrimaryLabels', {'UN','AA','AB'}, ...
'SecondaryLabels', {'Speaking'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
'Colors',[UNColor;AAColor;ABColor],'GroupType','betweenGroups');
boxplotGroup(ax16,{Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'UN')),:).Slope,Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'AA')),:).Slope,Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'AB')),:).Slope},...
'PrimaryLabels', {'UN','AA','AB'}, ...
'SecondaryLabels', {'Listening'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
...
boxplotGroup(ax17,{Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'UN')),:).PPD,Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'AA')),:).PPD,Tab_S_II(and(contains(Tab_S_II.Activity,'Speak'),contains(Tab_S_II.Setting,'AB')),:).PPD},...
'PrimaryLabels', {'UN','AA','AB'}, ...
'SecondaryLabels', {'Speaking'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
'Colors',[UNColor;AAColor;ABColor],'GroupType','betweenGroups');
boxplotGroup(ax18,{Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'UN')),:).PPD,Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'AA')),:).PPD,Tab_S_II(and(contains(Tab_S_II.Activity,'Listen'),contains(Tab_S_II.Setting,'AB')),:).PPD},...
'PrimaryLabels', {'UN','AA','AB'}, ...
'SecondaryLabels', {'Listening'}, ...
'interGroupSpace',2,'groupLabelType','Vertical', ...
'PlotStyle','Compact','BoxStyle','filled',...
