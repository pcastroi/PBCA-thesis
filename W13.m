...
GSW_MeanConv = conv([mean(GSW_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GSW_Mean,mean(GSW_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GSW_Mean = GSW_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GSW_B_Mean = reshape(mean(GSW_B,[1 2],'omitnan'),[],1)';
GSW_B_MeanConv = conv([mean(GSW_B_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GSW_B_Mean,mean(GSW_B_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GSW_B_Mean = GSW_B_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GSW_R_Mean = reshape(mean(GSW_R,[1 2],'omitnan'),[],1)';
GSW_R_MeanConv = conv([mean(GSW_R_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GSW_R_Mean,mean(GSW_R_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GSW_R_Mean = GSW_R_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GSW_RB_Mean = reshape(mean(GSW_RB,[1 2],'omitnan'),[],1)';
GSW_RB_MeanConv = conv([mean(GSW_RB_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GSW_RB_Mean,mean(GSW_RB_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GSW_RB_Mean = GSW_B_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GSW_Z_Mean = reshape(mean(GSW_Z,[1 2],'omitnan'),[],1)';
GSW_Z_MeanConv = conv([mean(GSW_Z_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GSW_Z_Mean,mean(GSW_Z_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GSW_Z_Mean = GSW_Z_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GLW_Mean = reshape(mean(GLW,[1 2],'omitnan'),[],1)';
GLW_MeanConv = conv([mean(GLW_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GLW_Mean,mean(GLW_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GLW_Mean = GLW_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GLW_B_Mean = reshape(mean(GLW_B,[1 2],'omitnan'),[],1)';
GLW_B_MeanConv = conv([mean(GLW_B_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GLW_B_Mean,mean(GLW_B_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GLW_B_Mean = GLW_B_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GLW_R_Mean = reshape(mean(GLW_R,[1 2],'omitnan'),[],1)';
GLW_R_MeanConv = conv([mean(GLW_R_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GLW_R_Mean,mean(GLW_R_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GLW_R_Mean = GLW_R_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GLW_RB_Mean = reshape(mean(GLW_RB,[1 2],'omitnan'),[],1)';
GLW_RB_MeanConv = conv([mean(GLW_RB_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GLW_RB_Mean,mean(GLW_RB_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GLW_RB_Mean = GLW_B_MeanConv(length(LPWindow)+1:end-length(LPWindow));
GLW_Z_Mean = reshape(mean(GLW_Z,[1 2],'omitnan'),[],1)';
GLW_Z_MeanConv = conv([mean(GLW_Z_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),GLW_Z_Mean,mean(GLW_Z_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
GLW_Z_Mean = GLW_Z_MeanConv(length(LPWindow)+1:end-length(LPWindow));

SW_Quiet_Mean = reshape(mean(SW_Quiet,[1 2],'omitnan'),[],1)';
SW_Quiet_MeanConv = conv([mean(SW_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_Quiet_Mean,mean(SW_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_Quiet_Mean = SW_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_B_Quiet_Mean = reshape(mean(SW_B_Quiet,[1 2],'omitnan'),[],1)';
SW_B_Quiet_MeanConv = conv([mean(SW_B_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_B_Quiet_Mean,mean(SW_B_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_B_Quiet_Mean = SW_B_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_R_Quiet_Mean = reshape(mean(SW_R_Quiet,[1 2],'omitnan'),[],1)';
SW_R_Quiet_MeanConv = conv([mean(SW_R_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_R_Quiet_Mean,mean(SW_R_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_R_Quiet_Mean = SW_R_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_RB_Quiet_Mean = reshape(mean(SW_RB_Quiet,[1 2],'omitnan'),[],1)';
SW_RB_Quiet_MeanConv = conv([mean(SW_RB_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_RB_Quiet_Mean,mean(SW_RB_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_RB_Quiet_Mean = SW_RB_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_Z_Quiet_Mean = reshape(mean(SW_Z_Quiet,[1 2],'omitnan'),[],1)';
SW_Z_Quiet_MeanConv = conv([mean(SW_Z_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_Z_Quiet_Mean,mean(SW_Z_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_Z_Quiet_Mean = SW_Z_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_Quiet_Mean = reshape(mean(LW_Quiet,[1 2],'omitnan'),[],1)';
LW_Quiet_MeanConv = conv([mean(LW_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_Quiet_Mean,mean(LW_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_Quiet_Mean = LW_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_B_Quiet_Mean = reshape(mean(LW_B_Quiet,[1 2],'omitnan'),[],1)';
LW_B_Quiet_MeanConv = conv([mean(LW_B_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_B_Quiet_Mean,mean(LW_B_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_B_Quiet_Mean = LW_B_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_R_Quiet_Mean = reshape(mean(LW_R_Quiet,[1 2],'omitnan'),[],1)';
LW_R_Quiet_MeanConv = conv([mean(LW_R_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_R_Quiet_Mean,mean(LW_R_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_R_Quiet_Mean = LW_R_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_RB_Quiet_Mean = reshape(mean(LW_RB_Quiet,[1 2],'omitnan'),[],1)';
LW_RB_Quiet_MeanConv = conv([mean(LW_RB_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_RB_Quiet_Mean,mean(LW_RB_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_RB_Quiet_Mean = LW_RB_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_Z_Quiet_Mean = reshape(mean(LW_Z_Quiet,[1 2],'omitnan'),[],1)';
LW_Z_Quiet_MeanConv = conv([mean(LW_Z_Quiet_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_Z_Quiet_Mean,mean(LW_Z_Quiet_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_Z_Quiet_Mean = LW_Z_Quiet_MeanConv(length(LPWindow)+1:end-length(LPWindow));

SW_SHL_Mean = reshape(mean(SW_SHL,[1 2],'omitnan'),[],1)';
SW_SHL_MeanConv = conv([mean(SW_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_SHL_Mean,mean(SW_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_SHL_Mean = SW_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_B_SHL_Mean = reshape(mean(SW_B_SHL,[1 2],'omitnan'),[],1)';
SW_B_SHL_MeanConv = conv([mean(SW_B_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_B_SHL_Mean,mean(SW_B_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_B_SHL_Mean = SW_B_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_R_SHL_Mean = reshape(mean(SW_R_SHL,[1 2],'omitnan'),[],1)';
SW_R_SHL_MeanConv = conv([mean(SW_R_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_R_SHL_Mean,mean(SW_R_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_R_SHL_Mean = SW_R_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_RB_SHL_Mean = reshape(mean(SW_RB_SHL,[1 2],'omitnan'),[],1)';
SW_RB_SHL_MeanConv = conv([mean(SW_RB_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_RB_SHL_Mean,mean(SW_RB_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_RB_SHL_Mean = SW_RB_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_Z_SHL_Mean = reshape(mean(SW_Z_SHL,[1 2],'omitnan'),[],1)';
SW_Z_SHL_MeanConv = conv([mean(SW_Z_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_Z_SHL_Mean,mean(SW_Z_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_Z_SHL_Mean = SW_Z_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_SHL_Mean = reshape(mean(LW_SHL,[1 2],'omitnan'),[],1)';
LW_SHL_MeanConv = conv([mean(LW_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_SHL_Mean,mean(LW_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_SHL_Mean = LW_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_B_SHL_Mean = reshape(mean(LW_B_SHL,[1 2],'omitnan'),[],1)';
LW_B_SHL_MeanConv = conv([mean(LW_B_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_B_SHL_Mean,mean(LW_B_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_B_SHL_Mean = LW_B_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_R_SHL_Mean = reshape(mean(LW_R_SHL,[1 2],'omitnan'),[],1)';
LW_R_SHL_MeanConv = conv([mean(LW_R_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_R_SHL_Mean,mean(LW_R_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_R_SHL_Mean = LW_R_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_RB_SHL_Mean = reshape(mean(LW_RB_SHL,[1 2],'omitnan'),[],1)';
LW_RB_SHL_MeanConv = conv([mean(LW_RB_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_RB_SHL_Mean,mean(LW_RB_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_RB_SHL_Mean = LW_RB_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_Z_SHL_Mean = reshape(mean(LW_Z_SHL,[1 2],'omitnan'),[],1)';
LW_Z_SHL_MeanConv = conv([mean(LW_Z_SHL_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_Z_SHL_Mean,mean(LW_Z_SHL_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_Z_SHL_Mean = LW_Z_SHL_MeanConv(length(LPWindow)+1:end-length(LPWindow));

SW_N60_Mean = reshape(mean(SW_N60,[1 2],'omitnan'),[],1)';
SW_N60_MeanConv = conv([mean(SW_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_N60_Mean,mean(SW_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_N60_Mean = SW_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_B_N60_Mean = reshape(mean(SW_B_N60,[1 2],'omitnan'),[],1)';
SW_B_N60_MeanConv = conv([mean(SW_B_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_B_N60_Mean,mean(SW_B_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_B_N60_Mean = SW_B_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_R_N60_Mean = reshape(mean(SW_R_N60,[1 2],'omitnan'),[],1)';
SW_R_N60_MeanConv = conv([mean(SW_R_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_R_N60_Mean,mean(SW_R_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_R_N60_Mean = SW_R_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_RB_N60_Mean = reshape(mean(SW_RB_N60,[1 2],'omitnan'),[],1)';
SW_RB_N60_MeanConv = conv([mean(SW_RB_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_RB_N60_Mean,mean(SW_RB_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_RB_N60_Mean = SW_RB_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_Z_N60_Mean = reshape(mean(SW_Z_N60,[1 2],'omitnan'),[],1)';
SW_Z_N60_MeanConv = conv([mean(SW_Z_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_Z_N60_Mean,mean(SW_Z_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_Z_N60_Mean = SW_Z_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_N60_Mean = reshape(mean(LW_N60,[1 2],'omitnan'),[],1)';
LW_N60_MeanConv = conv([mean(LW_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_N60_Mean,mean(LW_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_N60_Mean = LW_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_B_N60_Mean = reshape(mean(LW_B_N60,[1 2],'omitnan'),[],1)';
LW_B_N60_MeanConv = conv([mean(LW_B_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_B_N60_Mean,mean(LW_B_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_B_N60_Mean = LW_B_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_R_N60_Mean = reshape(mean(LW_R_N60,[1 2],'omitnan'),[],1)';
LW_R_N60_MeanConv = conv([mean(LW_R_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_R_N60_Mean,mean(LW_R_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_R_N60_Mean = LW_R_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_RB_N60_Mean = reshape(mean(LW_RB_N60,[1 2],'omitnan'),[],1)';
LW_RB_N60_MeanConv = conv([mean(LW_RB_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_RB_N60_Mean,mean(LW_RB_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_RB_N60_Mean = LW_RB_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_Z_N60_Mean = reshape(mean(LW_Z_N60,[1 2],'omitnan'),[],1)';
LW_Z_N60_MeanConv = conv([mean(LW_Z_N60_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_Z_N60_Mean,mean(LW_Z_N60_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_Z_N60_Mean = LW_Z_N60_MeanConv(length(LPWindow)+1:end-length(LPWindow));

SW_N70_Mean = reshape(mean(SW_N70,[1 2],'omitnan'),[],1)';
SW_N70_MeanConv = conv([mean(SW_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_N70_Mean,mean(SW_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_N70_Mean = SW_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_B_N70_Mean = reshape(mean(SW_B_N70,[1 2],'omitnan'),[],1)';
SW_B_N70_MeanConv = conv([mean(SW_B_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_B_N70_Mean,mean(SW_B_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_B_N70_Mean = SW_B_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_R_N70_Mean = reshape(mean(SW_R_N70,[1 2],'omitnan'),[],1)';
SW_R_N70_MeanConv = conv([mean(SW_R_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_R_N70_Mean,mean(SW_R_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_R_N70_Mean = SW_R_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_RB_N70_Mean = reshape(mean(SW_RB_N70,[1 2],'omitnan'),[],1)';
SW_RB_N70_MeanConv = conv([mean(SW_RB_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_RB_N70_Mean,mean(SW_RB_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_RB_N70_Mean = SW_RB_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
SW_Z_N70_Mean = reshape(mean(SW_Z_N70,[1 2],'omitnan'),[],1)';
SW_Z_N70_MeanConv = conv([mean(SW_Z_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),SW_Z_N70_Mean,mean(SW_Z_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
SW_Z_N70_Mean = SW_Z_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_N70_Mean = reshape(mean(LW_N70,[1 2],'omitnan'),[],1)';
LW_N70_MeanConv = conv([mean(LW_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_N70_Mean,mean(LW_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_N70_Mean = LW_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_B_N70_Mean = reshape(mean(LW_B_N70,[1 2],'omitnan'),[],1)';
LW_B_N70_MeanConv = conv([mean(LW_B_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_B_N70_Mean,mean(LW_B_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_B_N70_Mean = LW_B_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_R_N70_Mean = reshape(mean(LW_R_N70,[1 2],'omitnan'),[],1)';
LW_R_N70_MeanConv = conv([mean(LW_R_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_R_N70_Mean,mean(LW_R_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_R_N70_Mean = LW_R_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_RB_N70_Mean = reshape(mean(LW_RB_N70,[1 2],'omitnan'),[],1)';
LW_RB_N70_MeanConv = conv([mean(LW_RB_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_RB_N70_Mean,mean(LW_RB_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_RB_N70_Mean = LW_RB_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
LW_Z_N70_Mean = reshape(mean(LW_Z_N70,[1 2],'omitnan'),[],1)';
LW_Z_N70_MeanConv = conv([mean(LW_Z_N70_Mean(1:length(LPWindow)),'omitnan')*ones(1,length(LPWindow)),LW_Z_N70_Mean,mean(LW_Z_N70_Mean(end-length(LPWindow):end),'omitnan')*ones(1,length(LPWindow))],LPWindow,'same');
LW_Z_N70_Mean = LW_Z_N70_MeanConv(length(LPWindow)+1:end-length(LPWindow));
...
GSW_R_SEM = (reshape(std(GSW_R,0,[1 2],'omitnan'),[],1)/sqrt(numel(GSW_R(~isnan(GSW_R)))))';
GSW_RB_SEM = (reshape(std(GSW_RB,0,[1 2],'omitnan'),[],1)/sqrt(numel(GSW_RB(~isnan(GSW_RB)))))';
GSW_Z_SEM = (reshape(std(GSW_Z,0,[1 2],'omitnan'),[],1)/sqrt(numel(GSW_Z(~isnan(GSW_Z)))))';
...
GLW_R_SEM = (reshape(std(GLW_R,0,[1 2],'omitnan'),[],1)/sqrt(numel(GLW_R(~isnan(GLW_R)))))';
GLW_RB_SEM = (reshape(std(GLW_RB,0,[1 2],'omitnan'),[],1)/sqrt(numel(GLW_RB(~isnan(GLW_RB)))))';
GLW_Z_SEM = (reshape(std(GLW_Z,0,[1 2],'omitnan'),[],1)/sqrt(numel(GLW_Z(~isnan(GLW_Z)))))';

SW_Quiet_SEM = (reshape(std(SW_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_Quiet(~isnan(SW_Quiet)))))';
SW_B_Quiet_SEM = (reshape(std(SW_B_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_B_Quiet(~isnan(SW_B_Quiet)))))';
SW_R_Quiet_SEM = (reshape(std(SW_R_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_R_Quiet(~isnan(SW_R_Quiet)))))';
SW_RB_Quiet_SEM = (reshape(std(SW_RB_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_RB_Quiet(~isnan(SW_RB_Quiet)))))';
SW_Z_Quiet_SEM = (reshape(std(SW_Z_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_Z_Quiet(~isnan(SW_Z_Quiet)))))';
LW_Quiet_SEM = (reshape(std(LW_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_Quiet(~isnan(LW_Quiet)))))';
LW_B_Quiet_SEM = (reshape(std(LW_B_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_B_Quiet(~isnan(LW_B_Quiet)))))';
LW_R_Quiet_SEM = (reshape(std(LW_R_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_R_Quiet(~isnan(LW_R_Quiet)))))';
LW_RB_Quiet_SEM = (reshape(std(LW_RB_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_RB_Quiet(~isnan(LW_RB_Quiet)))))';
LW_Z_Quiet_SEM = (reshape(std(LW_Z_Quiet,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_Z_Quiet(~isnan(LW_Z_Quiet)))))';

SW_SHL_SEM = (reshape(std(SW_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_SHL(~isnan(SW_SHL)))))';
SW_B_SHL_SEM = (reshape(std(SW_B_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_B_SHL(~isnan(SW_B_SHL)))))';
SW_R_SHL_SEM = (reshape(std(SW_R_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_R_SHL(~isnan(SW_R_SHL)))))';
SW_RB_SHL_SEM = (reshape(std(SW_RB_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_RB_SHL(~isnan(SW_RB_SHL)))))';
SW_Z_SHL_SEM = (reshape(std(SW_Z_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_Z_SHL(~isnan(SW_Z_SHL)))))';
LW_SHL_SEM = (reshape(std(LW_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_SHL(~isnan(LW_SHL)))))';
LW_B_SHL_SEM = (reshape(std(LW_B_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_B_SHL(~isnan(LW_B_SHL)))))';
LW_R_SHL_SEM = (reshape(std(LW_R_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_R_SHL(~isnan(LW_R_SHL)))))';
LW_RB_SHL_SEM = (reshape(std(LW_RB_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_RB_SHL(~isnan(LW_RB_SHL)))))';
LW_Z_SHL_SEM = (reshape(std(LW_Z_SHL,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_Z_SHL(~isnan(LW_Z_SHL)))))';

SW_N60_SEM = (reshape(std(SW_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_N60(~isnan(SW_N60)))))';
SW_B_N60_SEM = (reshape(std(SW_B_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_B_N60(~isnan(SW_B_N60)))))';
SW_R_N60_SEM = (reshape(std(SW_R_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_R_N60(~isnan(SW_R_N60)))))';
SW_RB_N60_SEM = (reshape(std(SW_RB_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_RB_N60(~isnan(SW_RB_N60)))))';
SW_Z_N60_SEM = (reshape(std(SW_Z_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_Z_N60(~isnan(SW_Z_N60)))))';
LW_N60_SEM = (reshape(std(LW_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_N60(~isnan(LW_N60)))))';
LW_B_N60_SEM = (reshape(std(LW_B_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_B_N60(~isnan(LW_B_N60)))))';
LW_R_N60_SEM = (reshape(std(LW_R_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_R_N60(~isnan(LW_R_N60)))))';
LW_RB_N60_SEM = (reshape(std(LW_RB_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_RB_N60(~isnan(LW_RB_N60)))))';
LW_Z_N60_SEM = (reshape(std(LW_Z_N60,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_Z_N60(~isnan(LW_Z_N60)))))';

SW_N70_SEM = (reshape(std(SW_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_N70(~isnan(SW_N70)))))';
SW_B_N70_SEM = (reshape(std(SW_B_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_B_N70(~isnan(SW_B_N70)))))';
SW_R_N70_SEM = (reshape(std(SW_R_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_R_N70(~isnan(SW_R_N70)))))';
SW_RB_N70_SEM = (reshape(std(SW_RB_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_RB_N70(~isnan(SW_RB_N70)))))';
SW_Z_N70_SEM = (reshape(std(SW_Z_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(SW_Z_N70(~isnan(SW_Z_N70)))))';
LW_N70_SEM = (reshape(std(LW_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_N70(~isnan(LW_N70)))))';
LW_B_N70_SEM = (reshape(std(LW_B_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_B_N70(~isnan(LW_B_N70)))))';
LW_R_N70_SEM = (reshape(std(LW_R_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_R_N70(~isnan(LW_R_N70)))))';
LW_RB_N70_SEM = (reshape(std(LW_RB_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_RB_N70(~isnan(LW_RB_N70)))))';
LW_Z_N70_SEM = (reshape(std(LW_Z_N70,0,[1 2],'omitnan'),[],1)/sqrt(numel(LW_Z_N70(~isnan(LW_Z_N70)))))';
