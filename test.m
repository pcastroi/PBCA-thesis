...
SpeakT = [0.3 1 10;0.3 18 20;0.3 27 32;35+([0.3 5 12;0.3 15 23;0.3 25 30]);0.3 68 78];
ListenT = [0.3 5 12;0.3 15 23;0.3 25 30;35+([0.3 1 10;0.3 18 20;0.3 27 32]);0.3 69 71;0.3 72 75];
[SpeakTO,ListenTO] = overlap_windows(SpeakT, ListenT, 50);figure;startStop = SpeakT(:,2:3);width = startStop(:,2)-startStop(:,1);hold on;arrayfun(@(i)rectangle('Position', [startStop(i,1),0,width(i),1],'EdgeColor', 'none', 'FaceColor', SpeakColor), 1:size(startStop,1));
